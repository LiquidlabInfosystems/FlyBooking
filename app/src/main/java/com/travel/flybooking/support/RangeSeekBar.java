...
public class RangeSeekBar<T extends Number> extends android.support.v7.widget.AppCompatImageView {
    ...
    public static final int TEXT_LATERAL_PADDING_IN_DP = 5;
    private static final int INITIAL_PADDING_IN_DP = 10;
    private final int LINE_HEIGHT_IN_DP = 10;
    private final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private final Bitmap thumbImage = BitmapFactory.decodeResource(getResources(), R.mipmap.seek_thumb);
...
//                                                                           R.drawable.seek_thumb_disabled);
    ...
    private static final int DEFAULT_TEXT_SIZE_IN_DP = 13;
...
//                                normalizedToScreen(normalizedMinValue) - minTextWidth * 0.9f,
//                                mDistanceToTop + mTextSize,
//                                paint);
//
//            }
//            mDistanceToTop = PixelUtil.dpToPx(getContext(), 3);
//            canvas.drawText(maxText,
//                            normalizedToScreen(normalizedMaxValue) + maxTextWidth* 0.1f,
//                            mDistanceToTop + mTextSize,
//                            paint);
//        }
...
//        }
    ...
    private T normalizedToValue(double normalized) {
        ...
        return (T) numberType.toNumber(Math.round(v * 1000) / 1000d);
    }
